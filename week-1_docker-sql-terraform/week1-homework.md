...
Terraform will perform the following actions:
  ...
  + resource "google_bigquery_dataset" "demo_dataset" {
      ...
      + dataset_id                 = "demo_dataset_dezoomcamp"
  ...
  + resource "google_storage_bucket" "demo-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "EU"
      + name                        = "lively-citizen-412110-terra-bucket"
...
google_storage_bucket.demo-bucket: Creation complete after 2s [id=lively-citizen-412110-terra-bucket]
google_bigquery_dataset.demo_dataset: Creation complete after 3s [id=projects/lively-citizen-412110/datasets/demo_dataset_dezoomcamp]
